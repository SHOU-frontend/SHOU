...
const TestimonialsColumn: React.FC<TestimonialsColumnProps> = ({
  ...
  >
    {testimonials.map(({ text, imageSrc, name, username }, index) => (
      <div
        key={index}
        className="bg-neutral-800 p-6 rounded-lg shadow-lg min-w-[300px]"
      >
        ...
        <div className="flex items-center gap-2 mt-5">
          ...
          <div className="flex flex-col">
            <div className="font-medium text-white tracking-tight leading-5">
              {name}
            </div>
      ...
      <div className="flex justify-center">
        <div className="overflow-hidden w-full sm:w-1/3 md:w-1/2 lg:w-3/4">
          ...
          <div className="flex justify-end overflow-hidden mt-6 flex overflow-hidden [mask-image:linear-gradient(to_right,transparent,black,transparent)]">
            <TestimonialsColumn
              testimonials={testimonials.slice(5, 9)}
              direction="right"
            />
          </div>
        </div>
